			...
			<div class="container">
				<div class="row position-relative">
					<div class="col-md-8 mx-auto py-5">
						...
						<p class="small mt-2 mb-0"><strong>예시 )</strong>희망의 책, 백북스, 대전동화읽는어른모임, 대전시민아카데미  </p>
					</div>
			...
			<div class="container">
				<div class="d-flex justify-content-between align-items-center">
					...
					<div class="d-flex align-items-center">
						...
						<ul class="nav list-unstyled ml-3">
							<li class="nav-item mr-3">
								<a class="navbar-link" href="#"><strong>전화번호:</strong> (042) 252-9540</a>
							</li>
							<li class="nav-item mr-3">
								<a class="navbar-link" href="#"><strong>이메일:</strong> djbook21@hanmail.net</a>
							</li>
						</ul>
					</div>
					...
					<div class="d-flex align-items-center">
						<!-- Top Account -->
						<div class="dropdown">
						  <a class="dropdown-toggle" href="#" role="button" id="dropdownAccount" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="ti-user mr-2"></i>계정</a>
						  <div class="dropdown-menu mt-2 shadow" aria-labelledby="dropdownAccount">
						    <a class="dropdown-item" href="sign-in.html">로그인</a>
						    <a class="dropdown-item" href="sign-up.html">회원가입</a>
						  </div>
						</div>
						<!-- top link -->
						<ul class="nav">
              <li class="nav-item">
                  <a class="nav-link" href="contact.html">연락망</a>
              </li>
            </ul>
						<!-- top social -->
						<!-- 연락망이 존재하면 활성화 -->
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarCollapse">
					<ul class="navbar-nav ml-auto">
							...
							<div class="dropdown-menu pb-3 pb-lg-0" aria-labelledby="demosMenu" >
								<div class="d-block d-sm-flex">
									<ul class="list-unstyled w-100 w-sm-50 pr-0 pr-lg-5">
										<li> <a class="dropdown-item" href="index.html">회사소개</a> </li>
										<li> <a class="dropdown-item" href="index-2.html">연혁</a> </li>
										<li> <a class="dropdown-item" href="index-3.html">조직도</a> </li>
										<li> <a class="dropdown-item" href="index-4.html">찾아오시는 길</a> </li>
									</ul>
								</div>
							</div>
						</li>
						<!-- Menu item 2 Blog-->
						<li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle" href="#" id="blogMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">우리동네책방</a>
							<ul class="dropdown-menu" aria-labelledby="blogMenu">
								<li class="dropdown-submenu">
									<a class="dropdown-item dropdown-toggle" href="#">대전지역 도서관</a>
								...
								<li class="dropdown-submenu">
									<a class="dropdown-item dropdown-toggle" href="#">대전지역 책방</a>
									<ul class="dropdown-menu">
						...
						<!-- Menu item 3 Pages-->
						<li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle active" href="#" id="pagesMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">독서모임</a>
							<ul class="dropdown-menu" aria-labelledby="pagesMenu">
								<li> <a class="dropdown-item" href="about-classic.html">독서모임 리스트</a></li>
								<li> <a class="dropdown-item" href="about-classic.html">공지사항</a></li>
							</ul>
						</li>
						<!-- Menu item 4 Portfolio-->
						<li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle active" href="#" id="portfolioMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">소통의 장</a>
							<ul class="dropdown-menu" aria-labelledby="portfolioMenu">
								<li> <a class="dropdown-item" href="portfolio-grid-column-3.html">이달의 책</a> </li>
								<li> <a class="dropdown-item" href="portfolio-grid-column-4.html">행사 및 세미나</a> </li>
								<li> <a class="dropdown-item" href="portfolio-grid-column-5.html">독후감</a> </li>
								<li> <a class="dropdown-item" href="portfolio-grid-column-6.html">Q & A</a> </li>
							</ul>
						</li>
						...
						<li class="nav-item dropdown">
							...
							<ul class="dropdown-menu" aria-labelledby="elementsMenu" style="background-image:url(assets/images/menu-bg.jpg); background-position: right bottom; background-repeat: no-repeat;">
								<li> <a class="dropdown-item" href="elements-accordion.html">사업소개</a> </li>
								<li> <a class="dropdown-item" href="elements-action-box.html">개인후원</a> </li>
								<li> <a class="dropdown-item" href="elements-alerts.html">법인후원</a> </li>
								<li> <a class="dropdown-item" href="elements-animated-headlines.html">연말정산영수증 신청</a> </li>
							</ul>
						</li>
						<!-- Menu item 6 Docs-->
						<li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle" href="#" id="docMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">회원정보</a>
							<ul class="dropdown-menu" aria-labelledby="docMenu">
								<li> <a class="dropdown-item" href="https://wizixo.webestica.com/documentation/">정보수정</a> </li>
								<li> <a class="dropdown-item" href="https://wizixo.webestica.com/documentation/#getting-started-section">비밀번호 수정</a> </li>
								<li> <a class="dropdown-item" href="https://wizixo.webestica.com/documentation/#installation-section">나의 후원내역</a> </li>
								<li> <a class="dropdown-item" href="https://wizixo.webestica.com/documentation/#edit-section">내 모임</a> </li>
								<li> <a class="dropdown-item" href="https://wizixo.webestica.com/documentation/#faqs">내 독후감</a> </li>
							</ul>
						</li>
					</ul>
				</div>
				...
				<div class="navbar-nav">
					...
					<div class="nav-item border-0 d-none d-lg-inline-block align-self-center">
						<a href="#" class=" btn btn-sm btn-grad text-white mb-0">로그인</a>
					</div>
				</div>
				<!-- Header Extras End-->
			</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-3 text-center text-md-right mt-3 mt-md-0 align-self-center ">
					<a class="btn btn-outline-light mb-0" href="#"><a href="/meeting?command=meetingApplyAction" title="독서모임">독서모임 신청</a>
				</div>
			</div>
		</div>
	</section>
