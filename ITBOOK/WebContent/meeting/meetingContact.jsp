			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarCollapse">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle active" href="#" id="portfolioMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Portfolio</a>
		...
		<div class="container">
			<div class="row all-text-white">
				<div class="col-md-12 align-self-center">
					...
					<h1 class="font-weight-bold display-4 display-md-1 mb-2 mb-md-n4">Contact Us</h1>
				</div>
			</div>
		</div>
	</div>
				...
				<div class="col-md-3 mb-5">
					<div class="h-100">
						<div class="contact-map overflow-hidden">
							<div class="map-wrapper" id="map-silver" data-lat="-37.817274" data-lng="144.955914" data-string="121 King Street, Melbourne
