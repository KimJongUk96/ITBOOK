			...
			<div class="row">
				<div class="col-sm-12 mb-5">
					...
					<form name="frm" method="post"
						...
						<input type="hidden" name="metBrdNum"
							value="${metboard.metBrdNum }">
						<div class="table-responsive-sm">
							<table class="table table-hover">
								...
								<tr>
									...
									<td><a
										href='/notice?command=fileDownloadAction&file_name=${metboard.metBrdFile}'>${metboard.metBrdFile}</a></td>
									<th></th>
									<td></td>
								</tr>
								<tr>
									...
									<td><textarea name="noticeContent" class="form-control"
											rows="10" style="width: 100%;" disabled="disabled">${metboard.metBrdContent}</textarea></td>
									<th></th>
									<td></td>
								</tr>
							...
							<div align="right">
								...
								<input type="button" value="삭제" class="btn btn-primary"
									onclick="location.href='/meeting?command=metBoardDeleteAction&metBrdNum=${metboard.metBrdNum}'">
