   ...
   <div class="container">
      ...
      <div class="row mt-5">
         <div class="col-md-12">
            <table>
               <tr>
                  <td class="col-mt-4">대표자 : ${meetingVo.represent}</td>
                  <td class="col-mt-4">개설일자 : ${meetingVo.metName}</td>
                  <td class="col-mt-4">모임인원수 : ${meetingVo.headCount}명</td>
               </tr>

               <tr>
                  <td>
                     <a class="btn btn-grad mt-4" onclick="joinPopup()">모임 가입하기
      ...
      <table class="table table-hover">
         ...
         <c:forEach var="memList" items="${memList}">
            <c:if
               test="${memList.approval eq 'F' && memList.metNum eq meetingVo.metNum}">
               <input type="hidden" name="memNum" value="${memList.memNum}">
               <tr style="text-align: center;">
                  <td>${memList.memId}</td>
                  <td>${memList.memName}</td>
                  <td><a
                     href="/member?command=approvalMeeting&memNum=${memList.memNum}&metNum=${meetingVo.metNum}"><button
                           type="button" class="btn btn-primary btn-sm">승인</button></a>&nbsp;&nbsp;<a
                     href="/member?command=refuseMemberShip&memNum=${memList.memNum}&metNum=${meetingVo.metNum}"><button
                           type="button" class="btn btn-danger btn-sm">거절</button></a></td>
               </tr>
            </c:if>
         </c:forEach>
         </table>
      ...
      <div class="row mt-4">
         <!-- portfolio Greeting -->
         <div class="col-md-6">
            <h4 class="mb-4">${meetingVo.metName}의인사말</h4>
