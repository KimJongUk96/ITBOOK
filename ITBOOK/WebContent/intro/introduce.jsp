					...
					<div class="post-item post-bb">
						<div class="post-item-wrap">
							<div class="post-image">
								<img src="https://i.ibb.co/3dMsjgz/intro.png" alt="intro"
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 text-center mx-auto">
					<h2 class="mb-2">연혁</h2>
					<p class="mb-5">
						사람과의 만남이 중요하듯 또 다른 소중한 만남이 있습니다. <br>바로 책과의 만남입니다.
					</p>
						...
						<div class="card-body">
							...
							<div
								...
								<a href="#" class="list-group-item list-group-item-action"><span>01</span>
									12월 28일 독서문화 진흥법 제정/공포</a> <a href="#"
						...
						<div class="card-body">
							...
							<div
								...
								<a href="#" class="list-group-item list-group-item-action"><span>01</span>
									...
									요청</a> <a href="#" class="list-group-item list-group-item-action"><span>03</span>
									4월23일 대전시장의요청에 따라 한국문화원연합회 대전광역시지회에서는 지역문화원, 도서관, 시민단체가 협력을 통해
									책 읽는 운동을 지역문화운동으로 발전을 위한추진본부 구성 추진 </a> <a href="#"
									class="list-group-item list-group-item-action"><span>04</span>
