				...
				<div class="collapse navbar-collapse" id="navbarCollapse">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown megamenu">
							<a class="nav-link dropdown-toggle active" href="#" id="elementsMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Elements</a>
							<div class="dropdown-menu" aria-labelledby="elementsMenu" style="background-image:url(assets/images/menu-bg.jpg); background-position: right bottom; background-repeat: no-repeat;">
								<div class="container">
									<div class="row">
										...
										<div class="col-sm-6 col-lg-3">
											<ul class="list-unstyled">
												<li> <a class="dropdown-item active" href="elements-table.html">Table</a> </li>
		...
		<div class="container">
			<div class="row all-text-white">
				<div class="col-md-12 align-self-center">
					<h1 class="innerpage-title">Table</h1>
	...
	<section>
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-12 mb-5">
					<h5 class="text-center mb-4">Table bordered with stripped & lg row</h5>
					<div class="table-responsive-sm">
				...
				<div class="col-sm-12 mb-5">
					<h5 class="text-center mb-4">Table gradient header with stripped</h5>
					<div class="table-responsive-sm">
				...
				<div class="col-sm-12">
					<h5 class="text-center mb-4">Table dark with stripped</h5>
					<div class="table-responsive-sm">
