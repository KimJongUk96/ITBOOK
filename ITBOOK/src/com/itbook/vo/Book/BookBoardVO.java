...
public class BookBoardVO {
	...
	public String toString() {
		return "BookBoardVO [bookBrdNum=" + bookBrdNum + ", bookBrdTitle=" + bookBrdTitle + ", bookBrdContent="
				+ bookBrdContent + ", bookBrdDate=" + bookBrdDate + ", bookBrdCount=" + bookBrdCount + ", bookTitle="
				+ bookTitle + ", writer=" + writer + ", publisher=" + publisher + ", imgPath=" + imgPath + ", bookNum="
				+ bookNum + ", memNum=" + memNum + "]";
	}
